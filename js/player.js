	...
	try{
		webapis.voiceinteraction.setCallback(
			...
			onnextchapter: function(){
				console.log("ON NEXT CHAPTER");
				document.getElementById("desc").innerHTML = "<p><strong>ACTION:</strong> onnextchapter<strong>PARAMETERS:</strong> NONE</p>";
				launch_toast();
				return true;
			},
			onpreviouschapter: function(){
				console.log("ON PREVIOUS CHAPTER");
				document.getElementById("desc").innerHTML = "<p><strong>ACTION:</strong> onpreviouschapter<br><strong>PARAMETERS:</strong> NONE</p>";
				launch_toast();
				return true;
			}*/
		});
